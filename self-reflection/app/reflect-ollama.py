...
class LLMSelfReflection:
    ...
    def generate_response(self, query: str) -> str:
        ...
        try:
            ...
            # Assuming Ollama's response structure is similar to OpenAI, adjust as needed
    ...
    def _get_evaluation_score(self, criterion: str, prompt: str) -> float:
        ...
        try:
            ...
            score_data = json.loads(eval_response['message']['content'])
